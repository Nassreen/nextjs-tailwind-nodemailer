...
const generateEmailContent = (data)=>{
    ...
    const htmlData = Object.entries(data).reduce((str, [key, val])=>str += `<h1 className=ext-2xl align-left text-teal-400 font-medium  py-10 px-4  justify-center >${CONTACT_MESSAGE_FIELDS[key]}: \n ${val} \n \n</h1><p></p>`, "");
    return {
        text: stringData,
